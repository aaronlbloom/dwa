$(document).ready(function(){ 
	    ...
	    $(".addLine").live("click",function(){ 	 	
	 			  $name = $(this).attr('id');  
	 			  //console.log("foo");
	 	 	 	  $html = "<input type='text' hidden name='new_detail_type[]' value='"+$name+"'></input><div class='output_header'>&nbsp;</div><div class='output'> <input type='text' name='new_detail_descr[]'></div><br>"
				  $("."+$name+"").append($html );
	 	  ...
	 	  $("#addSection").live("change",function(){ 	 	
	 			 ...
	 			 if($value!=0){
					 ...
					 $html += 	"<input type='text' hidden name='new_detail_type[]' value='" + $value + "'></input>";
					 $html += 	"<div class='output_header'>&nbsp;</div>";
			         $html += 	"<div class='output'> <input type='text' name='new_detail_descr[]'></div>";
					 $html += 	"<br>";
